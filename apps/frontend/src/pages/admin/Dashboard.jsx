      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1">Tổng quan hiệu suất hệ thống và biến động thị trường hôm nay.</p>
          </div>
          <div className="flex gap-3">
             <div className="flex items-center gap-2 text-sm text-gray-500 bg-white px-3 py-2 rounded-md shadow-sm border">
                  ...
                  {recentProducts.map((p) => (
                    ...
                    >
                      ...
                      <TableCell className="text-right">
                        ...
                        {p.trend === 'stable' && <Badge variant="secondary" className="text-gray-600 bg-gray-100 shadow-none">Ổn định</Badge>}
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
                ...
                {recentUsers.map((u) => (
                  <div key={u.id} className="flex items-center justify-between group">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="font-medium text-gray-900 group-hover:text-primary transition-colors">{u.name || "Chưa đặt tên"}</p>
    ...
    <Card className="border-none shadow-sm bg-white hover:shadow-md transition-all duration-200">
      <CardContent className="p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          {trend && (
            <span className={`text-xs font-medium ${trendColor} bg-white px-2 py-1 rounded-full border border-gray-100 shadow-sm`}>
              {trend}
            </span>
          )}
        </div>
